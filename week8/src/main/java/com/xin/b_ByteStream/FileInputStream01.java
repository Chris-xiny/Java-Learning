...
public class FileInputStream01 {
    ...
    private static void method01() throws IOException {
        ...
        FileInputStream fin1=new FileInputStream("E:\\Code\\Java\\Intern\\week8\\src\\main\\java\\com\\xin\\b_ByteStream\\1.txt");
        int date;
        ...
        System.out.println("\n===int read(byte[] b)一次性读取一个数组,返回的是读取的字节个数===");
        FileInputStream fin2=new FileInputStream("E:\\Code\\Java\\Intern\\week8\\src\\main\\java\\com\\xin\\b_ByteStream\\1.txt");
        byte[] bytes1=new byte[2];//相当于缓存,一次读取两字节
