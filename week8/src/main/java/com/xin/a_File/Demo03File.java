...
public class Demo03File {
    public static void main(String[] args) {
        ...
        File file1=new File("Code\\Java\\Intern\\Note.md");
        System.out.println(file1.getAbsolutePath());//如果没有盘符(E:\\),他会在前面自动补充当前项目的路径
        System.out.println("==============================");
        ...
        File file4=new File("E:\\Code\\Java\\Intern\\week8\\src\\main\\java\\com\\xin\\a_File\\1.txt");
